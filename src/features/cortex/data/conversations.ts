  ...
  fr: [
    ...
    },
    {
      ...
      messages: [
        ...
        { type: 'cortex', text: '✅ Bon de commande créé\n\n📋 BC-2024-1234\n🥩 Bavette AAA : 18 kg\n💰 Estimé : 342 $\n🚚 Fournisseur : Viandes Premium\n\nPrêt à être envoyé ou téléchargé.', delay: 6400 },
    ...
    },
    {
      ...
      messages: [
        ...
        { type: 'cortex', text: 'Très bien 👌 Calcul des ingrédients en cours...', delay: 1200 },
        { type: 'user', text: 'Montre-moi le bon', delay: 4500 },
        { type: 'cortex', text: '✅ Bon de production créé\n\n📋 BP-2024-0856\n📅 Préparation : aujourd’hui\n\n🍝 Sauce bolognaise (12 L)\n• Bœuf haché : 6 kg\n• Tomates concassées : 8 L\n• Oignons : 1,2 kg\n• Carottes : 800 g\n• Vin rouge : 600 ml\n\n🍕 Pâte à pizza (8 kg)\n• Farine 00 : 5,2 kg\n• Eau : 3,2 L\n• Levure : 80 g\n• Huile d’olive : 240 ml\n\nTout est prêt pour la cuisine.', delay: 5700 },
        { type: 'user', text: 'Parfait, envoie-le !', delay: 11000 },
        { type: 'cortex', text: '✅ Envoyé en cuisine. Production planifiée 👨‍🍳', delay: 11700 }
      ]
    },
    {
      id: 5,
      messages: [
        ...
        { type: 'cortex', text: '✅ Rapport généré\n\n📋 RT-2024-1013\n📅 Période : 7 derniers jours\n🌡️ 168 relevés automatiques\n✅ Conformité : 99,4 %\n⚠️ 1 alerte mineure (vitrine salades)\n📊 Graphiques inclus\n📝 Conforme MAPAQ\n\nPrêt à télécharger ou imprimer.', delay: 7300 },
  ...
  en: [
    ...
    },
    {
      ...
      messages: [
        ...
        { type: 'cortex', text: '✅ Purchase order ready\n\n📋 PO-2024-1234\n🥩 AAA Bavette: 18 kg\n💰 Estimated: $342\n🚚 Supplier: Premium Meats\n\nYou can send or download it directly.', delay: 6400 },
    ...
    },
    {
      ...
      messages: [
        ...
        { type: 'cortex', text: 'Got it 👌 Calculating ingredients...', delay: 1200 },
        { type: 'user', text: 'Show me the order', delay: 4500 },
        { type: 'cortex', text: '✅ Production order created\n\n📋 PO-2024-0856\n📅 Prep: Today\n\n🍝 Bolognese sauce (12 L)\n• Ground beef 6 kg\n• Crushed tomatoes 8 L\n• Onions 1.2 kg\n• Carrots 800 g\n• Red wine 600 ml\n\n🍕 Pizza dough (8 kg)\n• 00 Flour 5.2 kg\n• Water 3.2 L\n• Yeast 80 g\n• Olive oil 240 ml\n\nOrder ready for the kitchen.', delay: 5700 },
        { type: 'user', text: 'Perfect, send it!', delay: 11000 },
        { type: 'cortex', text: '✅ Sent to kitchen. Production scheduled 👨‍🍳', delay: 11700 }
      ]
    },
    {
      id: 5,
      messages: [
        ...
        { type: 'cortex', text: '✅ Temperature report ready\n\n📋 TR-2024-1013\n📅 Period: Last 7 days\n🌡️ 168 automatic readings\n✅ Compliance: 99.4%\n⚠️ 1 minor alert (salad display)\n📊 Charts included\n📝 FDA compliant\n\nReady to download or print.', delay: 7300 },
